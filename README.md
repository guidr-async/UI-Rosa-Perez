# UI-Rosa-Perez
## Build Week
Description of application:  Here at Guidr, we made it so that you may easily plan and lead your fun-packed itineraries.  Guidr is the go-to platform that helps backcountry guides of all types log their private/professional trips.  Additionally, build your Outdoor Resume, login, create, read and update your trips with a trip type, location, and duration.
